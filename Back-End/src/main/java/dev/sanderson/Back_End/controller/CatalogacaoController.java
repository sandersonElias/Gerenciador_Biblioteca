...
public class CatalogacaoController {
    ...
    public ResponseEntity<CatalogacaoResponse> criarCatalogacao(@RequestBody CatalogacaoRequest catalogacaoDto){
    ...
    public ResponseEntity<List<CatalogacaoResponse>> buscarCatalogacao (@PathVariable String catalogacao){
        List<CatalogacaoResponse> catalogacaoDto = catalogacaoService.buscarGenero(catalogacao);
